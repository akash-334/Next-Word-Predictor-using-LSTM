...
y=to_categorical(y,num_classes=1057)
...
model=Sequential()
model.add(Embedding(1057,100,input_length=63))
model.add(LSTM(150))
model.add(Dense(1057,activation="Softmax"))
...
for i in range(5):
    ...
    pad=pad_sequences([tok],maxlen=63,padding='pre')
