...
Cricket is a bat-and-ball game played on a cricket field (see image of cricket pitch and creases) between two teams of eleven players each.[64] The field is usually circular or oval in shape and the edge of the playing area is marked by a boundary, which may be a fence, part of the stands, a rope, a painted line or a combination of these; the boundary must if possible be marked along its entire length.[65]
...
Main articles: Bowling (cricket) and Dismissal (cricket)
...
The game's only appearance in an Olympic Games was the 1900 Olympics.[136] However, it is scheduled to make a return, with the T20 format of the game, in the 2028 Summer Olympics in Los Angeles.[137][138]
...
First-class cricket in England is played for the most part by the 18 county clubs which contest the County Championship. The concept of a champion county has existed since the 18th century but the official competition was not established until 1890.[44] The most successful club has been Yorkshire, who had won 32 official titles (plus one shared) as of 2019.[139]

Australia established its national first-class championship in 1892–93 when the Sheffield Shield was introduced. In Australia, the first-class teams represent the various states.[140] New South Wales has the highest number of titles.
...
Limited overs
Main articles: List of domestic List A cricket competitions, List of domestic Twenty20 cricket competitions, and T10 leagues
Other
...
Main articles: Village cricket, Club cricket, and Schools cricket
...
At the grassroots level, local club cricket is essentially an amateur pastime for those involved but still usually involves teams playing in competitions at weekends or in the evening. Schools cricket, first known in southern England in the 17th century, has a similar scenario and both are widely played in the countries where cricket is popular.[141] Although there can be variations in game format, compared with professional cricket, the Laws are always observed and club/school matches are therefore formal and competitive events.[142] The sport has numerous informal variants such as French cricket.[143] On the North American side, in 2023, Monroe Township High School, in Monroe Township, Middlesex County, New Jersey, launched the first U.S. high school cricket club.[144][145]

Culture
Main page: Category:Cricket culture
Influence on everyday life
Cricket has had a broad impact on popular culture, both in the Commonwealth of Nations and elsewhere. It has, for example, influenced the lexicon of these nations, especially the English language, with various phrases such as "that's not cricket" (that's unfair), "had a good innings" (lived a long life) and "sticky wicket". "On a sticky wicket" (aka "sticky dog" or "glue pot")[146] is a metaphor[147] used to describe a difficult circumstance. It originated as a term for difficult batting conditions in cricket, caused by a damp and soft pitch.[148]

In the arts and popular culture
See also: Cricket in fiction, Cricket in film and television, and Cricket poetry
Cricket is the subject of works by noted English poets, including William Blake and Lord Byron.[149] Beyond a Boundary (1963), written by Trinidadian C. L. R. James, is often named the best book on any sport ever written.[150]


Tom Wills, cricketer and co-founder of Australian football
In the visual arts, notable cricket paintings include Albert Chevallier Tayler's Kent vs Lancashire at Canterbury (1907) and Russell Drysdale's The Cricketers (1948), which has been called "possibly the most famous Australian painting of the 20th century."[151] French impressionist Camille Pissarro painted cricket on a visit to England in the 1890s.[149] Francis Bacon, an avid cricket fan, captured a batter in motion.[149] Caribbean artist Wendy Nanan's cricket images[152] are featured in a limited edition first day cover for Royal Mail's "World of Invention" stamp issue, which celebrated the London Cricket Conference 1–3 March 2007, first international workshop of its kind and part of the celebrations leading up to the 2007 Cricket World Cup.[153]

In music, many calypsos make reference to the Sport of Cricket.

Influence on other sports
Cricket has close historical ties with Australian rules football and many players have competed at top levels in both sports.[154] In 1858, prominent Australian cricketer Tom Wills called for the formation of a "foot-ball club" with "a code of laws" to keep cricketers fit during the off-season. The Melbourne Football Club was founded the following year, and Wills and three other members codified the first laws of the game.[155] It is typically played on modified cricket fields.[156]

In England, a number of association football clubs owe their origins to cricketers who sought to play football as a means of keeping fit during the winter months. Derby County was founded as a branch of the Derbyshire County Cricket Club in 1884;[157] Aston Villa (1874) and Everton (1876) were both founded by members of church cricket teams.[158] Sheffield United's Bramall Lane ground was, from 1854, the home of the Sheffield Cricket Club, and then of Yorkshire; it was not used for football until 1862 and was shared by Yorkshire and Sheffield United from 1889 to 1973.[159]

In the late 19th century, a former cricketer, English-born Henry Chadwick of Brooklyn, New York, was credited with devising the baseball box score[160] (which he adapted from the cricket scorecard) for reporting game events. The first box score appeared in an 1859 issue of the Clipper.[161] The statistical record is so central to the game's "historical essence" that Chadwick is sometimes referred to as "the Father of Baseball" because he facilitated the popularity of the sport in its early days.[162] 
"""
...
tokenizer.fit_on_texts([cricket_text])
...
input_seq=[]
for sentence in cricket_text.split('.'):
    x = tokenizer.texts_to_sequences([sentence])
    
    # Filter out empty tokens and exclude the last token
    non_empty_tokens = [token for token in x[0][:-1] if token]
    
    # Check if the list is not empty before printing
    if non_empty_tokens:
        tokenized_sentence=non_empty_tokens
...
import numpy as np
text='test cricket continued to expand during the 20th century with the addition'
for i in range(5):
    
    tok=tokenizer.texts_to_sequences([text])[0]
    pad=pad_sequences([tok],maxlen=93,padding='pre')
    pos=np.argmax(model.predict(pad))
